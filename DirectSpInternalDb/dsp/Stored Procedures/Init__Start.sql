...
BEGIN
    ...
    IF (@IsInternalDatabase = 1 AND EXISTS (   SELECT   1
        ...
        EXEC dsp.ThrowAppException @ProcId = @@PROCID, @ExceptionId = 55001,
            @Message = 'DirectSpInternal ExceptionId must asigned between 55700 and 56000!';
    ...
    -- Lookups
    ----------------
    IF (@Reserved = 1) EXEC dsp.Log_Trace @ProcId = @@PROCID, @Message = 'Filling lookups';
